...
import sys
sys.path.append('../../')
#sys.path.append('../AEM_DIM_Bench_dir/')

import os
import AEM_DIM_Bench_dir
...
def creat_mm_dataset(data_dir=''):
    ...
    for i in range(num_models):
        ...
        state_dict_file = os.path.join('data4yang', 'state_dicts', 'mm{}.pt'.format(i))
